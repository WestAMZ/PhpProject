...
class Reporte extends FPDF
{
    ...
    {   $pdf = new FPDF();
        ...
        $query = "SELECT DATE_FORMAT(so.fecha_solicitud,'%m-%d-%Y') as fecha_solicitud,
...
WHERE e.id_jefe != e.id_empleado and e.id_empleado = '$id_empleado' AND so.id_solicitud = '$id_solicitud'";
