...
function loadAvisos(div,result,modal,message_area_modal)
{
    http = Connect();
    http.onreadystatechange = function()
    {
        if(http.readyState == 4 && http.status ==200)
        {
            ...
            message_area_modal.html("<img src='views/img/success.png'></img> el aviso ha sido publicado sastisfactoriamente");
            modal.openModal();
            result.html('');
        }
        else if(http.readyState != 4)
