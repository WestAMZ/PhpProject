<?php
    ...
    if(isset($_GET['search']) and $_GET['search'] !='')
    {
        ...
        $query = "SELECT i.id_insidencia,
                      ...
                      INNER JOIN sitio s ON e.id_sitio = s.id_sitio WHERE s.id_sitio = '$id' and i.estado = true and (i.titulo LIKE '%$search%' OR i.descripcion LIKE '%$search%') ORDER BY i.fecha DESC";
...
else
{
            ...
            $query = "SELECT i.id_insidencia,
                      ...
                      FROM usuario u INNER JOIN insidencia i ON u.id_usuario = i.id_usuario
                      INNER JOIN empleado e on u.id_empleado = e.id_empleado
                      INNER JOIN sitio s ON e.id_sitio = s.id_sitio WHERE s.id_sitio = '$id'and i.estado = true ORDER BY i.id_insidencia DESC";
